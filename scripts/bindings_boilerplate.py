...
class Module:
	...
	def __init__(self, root_dir: str, build_dir: str, name: str = "", supermodule: "Module" = None):
		...
		self.submodules = [Module(f.path, build_dir, supermodule=self) for f in os.scandir(root_dir) if f.is_dir()]
